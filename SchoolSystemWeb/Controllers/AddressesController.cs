...
namespace SchoolSystemWeb.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AddressId,City,Country,Region,PostalCode,StreetName,DateOfBirth")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressId,City,Country,Region,PostalCode,StreetName,DateOfBirth")] Address address)
        {
